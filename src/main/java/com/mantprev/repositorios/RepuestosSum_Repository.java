...
@Repository
public interface RepuestosSum_Repository extends CrudRepository <Repuestos_Sum, Integer>{
	...
	@Query("select R from Repuestos_Sum R where R.codigoRep = ?1")
	Repuestos_Sum getRepuestoByCodigoRep(String codigoRep);
