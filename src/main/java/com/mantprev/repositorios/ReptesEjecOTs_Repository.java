...
public interface ReptesEjecOTs_Repository extends CrudRepository<ReptesEjecOTs, Integer>{
	...
	@Query("select R from ReptesEjecOTs R where R.fechaEjec between :fecha1 and :fecha2 AND R.idEmpresa =:idEmpresa")
    public List<ReptesEjecOTs> getReptesEjecOTsByFechas(@Param("fecha1") Date fecha1, @Param("fecha2") Date fecha2, @Param("idEmpresa") int idEmpresa);
